...
//     console.log(restaurantList[i].info.name); // Access the name inside the info object
//     console.log(restaurantList[i].info.cuisines); // Access the cuisines array inside the info object
//     console.log(restaurantList[i].info.deliveryTime);
// }
...
const Resrtaurantcard = ({ cloudinaryImageId, name, cuisines, rating, deliverytime, costForTwo }) => {

  const api = "https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+cloudinaryImageId
  return (
    <div className="res-card" >
      <img width={203} height={155} src={api} />
      <h3>{name}</h3>
      <h4>{cuisines.join(",")}</h4>
      <h4>{rating} stars</h4>
